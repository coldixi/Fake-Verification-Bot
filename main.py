...
async def start(ctx):
    ...
    embed = nextcord.Embed(title="**Verification required!**", description= To acces this server, you need to pass the verification first  Press the button below", color=5003474)
